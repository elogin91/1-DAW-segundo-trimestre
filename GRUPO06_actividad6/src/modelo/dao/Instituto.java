...
public class Instituto implements InstitutoDao {
	...
	// Método que crea objetos que heredan de Persona, y los añada de la lista
	// personas.
	private void cargarDatos() {
		personas.add(new Administrativo("999999999Z", "Sara Lopez Vega", "C/ Real, 6", "952 555 555",
				"hacer matrículas y controlar asistencias"));
		;
		personas.add(new Administrativo("888888888Y", "Ruben Diaz Velgara", "C/ Malaga, 10", "952 555 555",
				"atender llamadas y comprobar los pagos"));
		;
		personas.add(new Profesor("777777777A", "Maria Jiménez Soria", "C/Almadraba, 5", "956 333 333",
				"Matemáticas y física"));
		personas.add(new Profesor("666666666B", "Eduardo Arauzo Perez", "C/Arganda, 56", "956 333 333",
				"Lengua y literatura"));
		personas.add(new Alumno("555555555N", "Lucia Parrado Mendez", "Avda, Descubrimientos, 17", "958 444 444",
				"1º de Bachillerato"));
		personas.add(new Alumno("123987456L", "Javier Nieto Sanchez", "Plaza España, 19", "958 444 444",
				"2º de Bachillerato"));
	}

	// Implementación de los métodos de la interfaz InstitutoDao.
	// Añade una persona a la lista de "personas", si no hay en ella una persona con
	// el mismo nif.
	@Override
	...
	// Crea y devuelve una lista de persona, pertenecientes a la lista de personas
	// del Instituto
